...
const abi = [
  ...
  { "inputs": [{ "internalType": "int256", "name": "_id", "type": "int256" }], "name": "buyPremiumTag", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "stateMutability": "payable", "type": "function" },
  { "inputs": [{ "internalType": "int256", "name": "", "type": "int256" }], "name": "isPremium", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "stateMutability": "view", "type": "function" },
...
export const buyPremiumTag = async (id: number): Promise<boolean> => {
  return await withContract(async (contract) => {
    const tx = await contract.buyPremiumTag(id, { value: ethers.parseEther("1") });
    await tx.wait();
    return true;
  }) ?? false;
};
